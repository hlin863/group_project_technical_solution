...
def sample_simulation(sample_t, sample_infected, fit_function): # function to perform simulation on the samples.
    ...
    for i in range(0, len(sample_t)): # iterate through the sample data
        sample_output.append(fit_function(sample_t[i], a_f, b_f, c_f)) # simulates the data
    
    return sample_output

sample_1_output = sample_simulation(sample_time_1, sample_infected_1, logistic_fit) # perform simulation on the first section
sample_2_output = sample_simulation(sample_time_2, sample_infected_2, logistic_fit) # perform simulation on the second section
sample_3_output = sample_simulation(sample_time_3, sample_infected_3, logistic_fit) # perform simulation on the third section
sample_4_output = sample_simulation(sample_time_4, sample_infected_4, logistic_fit) # perform simulation on the fourth section
sample_5_output = sample_simulation(sample_time_5, sample_infected_5, logistic_fit) # perform simulation on the fifth section
